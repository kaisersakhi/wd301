            ...
            <div className="m-auto max-w-2xl py-8">
                ...
                <div className="flex py-8 gap-4">
                    <div className="py-2 px-4 border border-gray-400 rounded-lg w-1/2">
                        ...
                        <TaskCard title="Write blog" assigneeName="Kaiser Sakhi" dueDate="20-2-2003"/>
                        <TaskCard title="Write blog" assigneeName="Kaiser Sakhi" dueDate="02-02-2022"/>
                    ...
                    <div className="py-2 px-4 border border-gray-400 rounded-lg  w-1/2">
                        ...
                        <TaskCard title="Write blog" assigneeName="Kaiser Sakhi" completedAtDate="02-02-2022"/>
                        <TaskCard title="Write blog" assigneeName="Kaiser Sakhi" completedAtDate="02-02-2022"/>
                        <TaskCard />
                    </div>
                </div>
